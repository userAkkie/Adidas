    ...
    <div>
      ...
      <div className="hidden lg:block">
        <div className="flex px-16 pt-6 justify-end">
          <div className="gap-6 items-center flex">
            ...
            <button>
              <img
                src="./public/forIcons/usaFlag.png"
                alt="usa"
                width={"20px"}
              />
            </button>
      ...
      <div className="flex items-center justify-between lg:hidden px-4">
        <div className="flex items-center gap-3">
          ...
          <Link to={"/likes"}>
            <img
              src="./public/forIcons/likeIcon.webp"
              alt="like"
              width={"20px"}
            />
          </Link>
        ...
        <div>
          <Link to={"/"}>
            <img
              src="./public/forIcons/adidas.png"
              alt="adidas"
              width={"60px"}
            />
          </Link>
        ...
        <div className="flex items-center gap-3 ">
          <Link to={"/user"}>
            <img
              src="./public/forIcons/userIcon.webp"
              alt="user"
              width={"20px"}
            />
          </Link>
          <Link to={"/basket"}>
            <img
              src="./public/forIcons/basketIcon.webp"
              alt="basket"
              width={"20px"}
            />
          </Link>
        ...
        <div className="flex items-center justify-between px-16 border-b border-solid border-gray-200">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) => console.log(e.target.value)} // Bu qatordan foydalanib tekshiring
            />
            <Link to={"/user"}>
              <img
                src="./public/forIcons/userIcon.webp"
